...
Сигурен съм, че има много по-лесен начин да се реши, но не го виждам. Само еднакво сложни вариации: например отделните "думи" може да са int и да ги обхождам 
дали се делят без остатък на цифрата, от която са състевени, пак в switch. По същество е същото.
Може ли едно рамо?
 */
